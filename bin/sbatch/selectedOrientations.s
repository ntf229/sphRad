...
--ageSmooth=True --SF=True --tauClear=10 --clumps=False --numCells=10 --numClumps=50 \
--numPhotons=1e9 --pixels=1 \
--dustFraction=0.4 --maxTemp=16000 --SSP=FSPS_Chabrier --galaxy=${galaxies[$SLURM_ARRAY_TASK_ID]}"
