...
#SBATCH --time=30:00
#SBATCH --mem=20GB
#SBATCH --job-name=storeParameterSpaceAsFits
...
python /home/ntf229/sphRad/bin/storeParameterSpaceAsFits.py \
--ageSmooth=True --SF=True --clumps=False --numCells=8 --numClumps=34 \
--numPhotons=1e9 --pixels=1 --SSP=FSPS_Chabrier --maxTemp=16000"
