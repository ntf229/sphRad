...
galaxies=( 'g1.88e10' 'g1.89e10' 'g1.90e10' 'g2.34e10' 'g2.63e10' 'g2.64e10' 'g2.80e10' 'g2.83e10'
                'g2.94e10' 'g3.19e10' 'g3.44e10' 'g3.67e10' 'g3.93e10' 'g4.27e10' 'g4.48e10' 'g4.86e10' 'g4.94e10'
...
python /home/ntf229/sphRad/bin/temp.py \
--ageSmooth=True --SF=True --tauClear=2 --clumps=False --numCells=8 --numClumps=34 \
--inc=0 --dust=True --numPhotons=1e9 --pixels=2000 \
--dustFraction=0.1 --maxTemp=16000 --galaxy=${galaxies[$SLURM_ARRAY_TASK_ID]}"
