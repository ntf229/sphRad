...
if __name__=='__main__':
    ...
    particlePath = '/scratch/ntf229/sphRad/resources/NIHAO/Particles/'
    ...
    if eval(args.clumps):
        ...
        np.save(particlePath+'gas.npy',np.float32(np.c_[g.ag_x, g.ag_y, g.ag_z, g.ag_h, g.ag_M, g.ag_Z, g.ag_T]))
    else:
